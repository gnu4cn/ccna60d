...
物理及数据链路层的故障，以及这些故障对路由协议及其它流量造成影响的方式，已在早先的课程模块中有所说明。对这些故障的排除，可以使用`show interfaces`、`show interfaces counters`、`show vlan`及`show spanning-tree`等命令，以及其它一些在前面课程模块（[物理及数据链路层故障排除](https://github.com/gnu4cn/ccna60d/tree/75326dd612bf7bd9187225fbc97b22ef82cbb418/d15-Layer_1-and-Layer_2-Troubleshooting.html)）中讲到的命令。这里为了避免重复，就不再重申那些物理及数据链路层故障排除步骤了。
...
![EIGRP&#x7684;&#x81EA;&#x52A8;&#x6C47;&#x603B;](.gitbook/assets/3701.png) _图 37.1 -- EIGRP的自动汇总_
...
![&#x638C;&#x63E1;&#x53EF;&#x884C;&#x6761;&#x4EF6;](.gitbook/assets/3702.png) _图 37.2 -- 掌握可行条件_
...
![EIGRP&#x7684;&#x6C34;&#x5E73;&#x5206;&#x5272;](.gitbook/assets/3703.png) _图37.3 -- EIGRP的水平分割_
...
![EIGRP&#x7684;&#x6C47;&#x603B;](.gitbook/assets/3704.png) _图37.4 -- EIGRP的汇总_
