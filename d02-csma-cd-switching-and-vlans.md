...
![&quot;&#x7AEF;&#x53E3;&#x76D1;&#x542C;&#x7740;&#x7EBF;&#x8DEF;&quot;](.gitbook/assets/021.png)
...
![&quot;CSMA/CD &#x8FC7;&#x7A0B;&quot;](.gitbook/assets/022.png)
...
![&quot;&#x4E00;&#x53F0;&#x4EA4;&#x6362;&#x673A;&#x521B;&#x5EFA;&#x51FA;&#x4E24;&#x4E2A;&#x51B2;&#x7A81;&#x57DF;&quot;](.gitbook/assets/023.png)

_图 2.3 -- 一台交换机创建出两个冲突域_
...
![&quot;&#x5E7F;&#x64AD;&#x57DF;&#x548C;&#x51B2;&#x7A81;&#x57DF;&quot;](.gitbook/assets/025.png)
...
![&quot;&#x540C;&#x4E00;&#x63A5;&#x53E3;&#x4E0A;&#x7684;&#x591A; MAC &#x5730;&#x5740;&quot;](.gitbook/assets/027.png)

_图 2.7 -- 同一接口上的多 MAC 地址_
...
![&quot;&#x6BCF;&#x53F0;&#x8BBE;&#x5907;&#x90FD;&#x542C;&#x7740;&#x5176;&#x5B83;&#x8BBE;&#x5907;&quot;](.gitbook/assets/028.png)
...
![&quot;&#x96C6;&#x7EBF;&#x5668;&#x5728;&#x6BCF;&#x4E2A;&#x7AEF;&#x53E3;&#x4E0A;&#x90FD;&#x53D1;&#x9001;&#x5E27;&quot;](.gitbook/assets/029.png)

_图 2.9 -- 集线器在每个端口上都发送帧_
...
![&quot;&#x4EA4;&#x6362;&#x673A;&#x5EFA;&#x7ACB;&#x8D77;&#x4E00;&#x5F20; MAC &#x5730;&#x5740;&#x8868;&quot;](.gitbook/assets/0210.png)

_图 2.10 -- 交换机建立起一张 MAC 地址表_
...
![&quot;&#x5E7F;&#x64AD;&#x5E27;&#x5728;&#x6240;&#x6709;&#x63A5;&#x53E3;&#x4E0A;&#x53D1;&#x51FA;&quot;](.gitbook/assets/0211.png)

_图 2.11 -- 广播帧在所有接口上发出_
...
![&quot;&#x4EE5;&#x592A;&#x7F51; \`802.3\` &#x5E27;&#x7ED3;&#x6784;&quot;](.gitbook/assets/0212.png)

_图 2.12 -- 以太网 `802.3` 帧结构_
...
![&quot;&#x8DEF;&#x7531;&#x5668;&#x9694;&#x79BB;&#x5E7F;&#x64AD;&#x57DF;&quot;](.gitbook/assets/0213.png)
...
![&quot;VLAN &#x4E0B;&#x7684;&#x5E7F;&#x64AD;&#x57DF;&quot;](.gitbook/assets/0214.png)
...
![&quot;VLANs &#x6D88;&#x9664;&#x5C40;&#x57DF;&#x7F51;&#x7684;&#x7269;&#x7406;&#x8FB9;&#x754C;&quot;](.gitbook/assets/0215.png)

_图 2.15 -- VLANs 消除局域网的物理边界_
...
![&quot;ISL &#x7684;&#x6807;&#x8BB0;&#x65B9;&#x5F0F;&quot;](.gitbook/assets/0216.png)
...
![&quot;\`802.1Q\` &#x7684;&#x6807;&#x8BB0;&#x65B9;&#x5F0F;&quot;](.gitbook/assets/0217.png)

_图 2.17 -- `802.1Q` 的标记方式_

传送来自多个 VLANs 数据的那个端口叫做干线（trunk）端口。trunk 端口可以使用 ISL 协议，也可以使用 `802.1Q` 协议。`802.1Q` 中的一个特别概念是"原生 VLAN（native VLAN）"。这是一种特别的 VLAN 类型，它上面的帧是没有打标签的。原生 VLAN 的目的是让交换机在某个接口上运行 `802.1Q` 中继（单一链上的多 VLANs），即便另一设备无法支持中继的情况下，原生 VLAN 上的流量仍能通过该链路。如交换机在一条中继链路上收到未打标签的流量，就会假定这些流量是属于原生 VLAN 上的。**思科将 `VLAN 1` 作为**_**默认**_**的原生 VLAN**。
...
我们知道交换机采用了一种叫做“帧标记（frame tagging）” 的方式，来将流量在不同 VLANs 上保持隔离。交换机把包含了 VLAN ID 的一个头部添加进帧中。在图 2.15 中，一楼交换机将会给来自 `VLAN 2` 的流量打上标记后，传给交换机 `2`, 交换机 `2` 将会看到这个标记，从而得知该流量需要呆在 `VLAN 2` 中。**这样的流量只能在叫做**_**中继链路**_**的链路上通过。`VLAN 1` 通常被指定为原生 VLAN（native VLAN），而**_**原生 VLAN 上的流量不被标记**_。关于原生 VLAN 的内容，后面会提到。
...
![&quot;VLAN &#x6807;&#x8BB0;&#x6CD5;&quot;](.gitbook/assets/0218.png)
...
![&quot;&#x5E38;&#x89C1;&#x4EA4;&#x6362;&#x673A;&#x6545;&#x969C;&#x53CA;&#x89E3;&#x51B3;&#x65B9;&#x6CD5;&quot;](.gitbook/assets/0220.png)

_图 2.20 -- 常见交换机故障及解决方法_
