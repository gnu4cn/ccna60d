...
![&quot;Cisco 2960 &#x4EA4;&#x6362;&#x673A;&quot;](.gitbook/assets/60days-1.png)
...
![&quot;&#x4EA4;&#x6362;&#x673A;&#x63A5;&#x53E3;&#x7C7B;&#x578B;&quot;](.gitbook/assets/60days-2.png)
...
![&quot;&#x4E00;&#x53F0;&#x6A21;&#x5757;&#x5316;&#x8DEF;&#x7531;&#x5668;&#xFF0C;&#x53F3;&#x8FB9;&#x6709;&#x4E00;&#x4E2A;&#x7A7A;&#x7740;&#x7684;&#x63D2;&#x69FD;&quot;](.gitbook/assets/60days-3.png)

_图 1.3 -- 一台模块化路由器，右边有一个空着的插槽_
...
![&quot;&#x8DEF;&#x7531;&#x5668;&#xFF0C;routers&quot;](.gitbook/assets/60days-13.png)

![&quot;&#x8DEF;&#x7531;&#x5668;&#xFF0C;routers&quot;](.gitbook/assets/60days-4.png)

_路由器，routers_

![&quot;&#x4EA4;&#x6362;&#x673A;&#xFF0C;switch&quot;](.gitbook/assets/60days-5.png)

_交换机，switch_

![&quot;&#x6709;&#x9632;&#x706B;&#x5899;&#x7684;&#x8DEF;&#x7531;&#x5668;&quot;](.gitbook/assets/60days-6.png)

_有防火墙的路由器_

![&quot;&#x65E0;&#x7EBF;&#x8DEF;&#x7531;&#x5668;&quot;](.gitbook/assets/60days-7.png)

_无线路由器_

![&quot;&#x591A;&#x5C42;&#x4EA4;&#x6362;&#x673A;&quot;](.gitbook/assets/60days-8.png)

_多层交换机_

![&quot;&#x4E91;--&#x7535;&#x8BAF;&#x7AEF;&#x8BBE;&#x5907;&quot;](.gitbook/assets/60days-9.png)

_云--电讯端设备_

![&quot;&#x7EC8;&#x7AEF;&#x8BBE;&#x5907; -- &#x4E00;&#x53F0; PC/&#x4E32;&#x884C;&#x7EBF;/&#x4EE5;&#x592A;&#x7F51;&#x8FDE;&#x63A5;&quot;](.gitbook/assets/60days-10.png)

_终端设备 -- 一台 PC/串行线/以太网连接_

![&quot;IP &#x7535;&#x8BDD;&quot;](.gitbook/assets/60days-11.png)

_IP 电话_

![&quot;&#x9632;&#x706B;&#x5899;&quot;](.gitbook/assets/60days-12.png)
...
![&quot;&#x70B9;&#x5BF9;&#x70B9;&#x62D3;&#x6251;&quot;](.gitbook/assets/60days-14.png)
...
![&quot;&#x603B;&#x7EBF;&#x62D3;&#x6251;&quot;](.gitbook/assets/60days-15.png)
...
![&quot;&#x661F;&#x5F62;&#x62D3;&#x6251;&quot;](.gitbook/assets/60days-16.png)

_图 1.6 -- 星形拓扑_

**环形拓扑**

令牌环网络（token ring networks）和光纤分布式数据接口网络（Fiber Distributed Data Interface, FDDI）网络使用此种拓扑，而两种网络在多年前就已被弃用了。 ![&quot;&#x4EE4;&#x724C;&#x73AF;&#x62D3;&#x6251;&quot;](.gitbook/assets/60days-17.png)

_图 1.7 -- 令牌环拓扑_

FDDI 网络中会用到双环连接的环形拓扑，以提供在一个环失效时的冗余。

![&quot;&#x53CC;&#x73AF;&#x62D3;&#x6251;&quot;](.gitbook/assets/60days-18.png)
...
![&quot;&#x8F74;&#x8F90;&#x5F0F;&#x62D3;&#x6251;&quot;](.gitbook/assets/60days-21.png)

_图 1.11 -- 轴辐式拓扑（Hub-and-Spoke Topology）_
...
![&quot;&#x73AF;&#x662F;&#x5728;&#x96C6;&#x7EBF;&#x5668;&#x5185;&#x90E8;&quot;](.gitbook/assets/60days-22.png)
...
![&quot;&#x5C01;&#x88C5;&quot;](.gitbook/assets/60days-23.png)
...
![&quot;&#x6D41;&#x63A7;&quot;](.gitbook/assets/60days-24.png)
...
![&quot;&#x7A97;&#x53E3;&#x673A;&#x5236;&quot;](.gitbook/assets/60days-25.png)
...
![&quot;&#x901A;&#x544A;&#x673A;&#x5236;&quot;](.gitbook/assets/60days-26.png)
...
![&quot;&#x4E09;&#x6B21;&#x63E1;&#x624B;&quot;](.gitbook/assets/60days-27.png)
...
_表 1.4 -- TCP/IP 模型到 OSI 模型的对应关系_
...
![&quot;&#x4E00;&#x53F0;&#x4E3B;&#x673A;&#x4E3A;&#x627E;&#x5230;&#x53E6;&#x4E00;&#x4E3B;&#x673A; MAC &#x5730;&#x5740;&#x800C;&#x53D1;&#x51FA;&#x7684;&#x5E7F;&#x64AD;&quot;](.gitbook/assets/60days-28.png)

_图 1.18 -- 一台主机为找到另一主机 MAC 地址而发出的广播_
...
![&quot;&#x8DEF;&#x7531;&#x5668;&#x91C7;&#x7528;&#x4EE3;&#x7406; ARP &#x6280;&#x672F;&#x4EE5;&#x5141;&#x8BB8;&#x4E3B;&#x673A;&#x80FD;&#x591F;&#x8FDE;&#x63A5;&quot;](.gitbook/assets/29.png)

_图 1.19 -- 路由器采用代理 ARP 技术以允许主机能够连接_
...
![&quot;&#x6570;&#x636E;&#x5305;&#x5728;&#x8BBE;&#x5907;&#x95F4;&#x5F80;&#x590D;&#x65F6;&#xFF0C;MAC &#x5730;&#x5740;&#x7684;&#x6539;&#x53D8;&quot;](.gitbook/assets/30.png)

_图 1.20 -- 数据包在设备间往复时，MAC 地址的改变_
...
![&quot;ipconfig /all &#x547D;&#x4EE4;&#x7684;&#x8F93;&#x51FA;&quot;](.gitbook/assets/31.png)

_图 1.21 -- ipconfig /all 命令的输出_
...
![&quot;&#x53CC;&#x5DE5;&#x62D3;&#x6251;&#xFF0C;Duplex Topology&quot;](.gitbook/assets/60days-32.png)

_图 1.22 -- 双工拓扑，Duplex Topology_
...
![&quot;RJ45 &#x516C;&#x5934;&quot;](.gitbook/assets/60days-33.png)

_图 1.23 -- RJ45 公头_

![&quot;RJ45 &#x6BCD;&#x5934;&quot;](.gitbook/assets/60days-34.png)
...
![&quot;&#x5BF9;&#x6BD4;&#x7F51;&#x7EBF;&#x4E24;&#x7AEF;&quot;](.gitbook/assets/60days-35.png)

_图 1.25 -- 对比网线两端_

![&quot;&#x7F51;&#x7EBF;&#x4E24;&#x7AEF;&#x662F;&#x4E00;&#x6837;&#x7684;&quot;](.gitbook/assets/60days-36.png)
...
![&quot;&#x9488;&#x811A; 1 &#x5230; &#x9488;&#x811A; 3&#xFF0C;&#x9488;&#x811A; 2 &#x5230;&#x9488;&#x811A; 6&quot;](.gitbook/assets/60days-37.png)

_图 1.27 -- 针脚 1 到 针脚 3，针脚 2 到针脚 6_
...
![&quot;&#x4E00;&#x6761;&#x5178;&#x578B;&#x7684;&#x7FFB;&#x8F6C;&#x7EBF;&quot;](.gitbook/assets/38.png)

_图 1.28 -- 一条典型的翻转线_

![&quot;&#x6240;&#x6709;&#x9488;&#x811A;&#x90FD;&#x4EA4;&#x6362;&#x4E86;&#x4F4D;&#x7F6E;&quot;](.gitbook/assets/39.png)
...
![&quot;&#x4E00;&#x6761; COM &#x5230; USB &#x7684;&#x8F6C;&#x6362;&#x7EBF;&quot;](.gitbook/assets/40.png)

_图 1.30 -- 一条 COM 到 USB 的转换线_

![&quot;&#x5C06;&#x4E32;&#x884C;&#x7EBF;&#x8FDE;&#x63A5;&#x5230;&#x7B14;&#x8BB0;&#x672C;&#x7535;&#x8111;&#x7684;&#x4E32;&#x884C;&#x7AEF;&#x53E3;&quot;](.gitbook/assets/41.png)

_图 1.31 -- 将串行线连接到笔记本电脑的串行端口_

![&quot;&#x5C06;&#x4E32;&#x884C;&#x7EBF;&#x8FDE;&#x63A5;&#x5230;&#x8DEF;&#x7531;&#x5668;&#x6216;&#x4EA4;&#x6362;&#x673A;&#x7684;&#x63A7;&#x5236;&#x53F0;&#x7AEF;&#x53E3;&quot;](.gitbook/assets/42.png)

_图 1.32 -- 将串行线连接到路由器或交换机的控制台端口_
...
![&quot;&#x4E00;&#x6761; DB60 &#x7EBF;&#x7F06;&quot;](.gitbook/assets/43.png)

_图 1.33 -- 一条 DB60 线缆_

![&quot;&#x4E00;&#x5757; WIC-1T &#x63D2;&#x5361;&#x4E0A;&#x7684; DB60 &#x4E32;&#x884C;&#x63A5;&#x53E3;&quot;](.gitbook/assets/44.png)

_图 1.34 -- 一块 WIC-1T 插卡上的 DB60 串行接口_

还有一种思科经常推介的、用于广域网接口卡（WAN Interface Cards, WICs）的，叫做小巧串行线（smart serial cable）的类型。如图 1.35 所示。

![&quot;&#x5C0F;&#x5DE7;&#x4E32;&#x884C;&#x7EBF;&quot;](.gitbook/assets/45.png)

_图 1.35 -- 小巧串行线，Smart Serial Cable_

在使用这种类型线缆时，你当然需要恰当的接口卡，此种接口卡如图 1.36 所示。

![&quot;&#x4F7F;&#x7528;&#x5C0F;&#x5DE7;&#x4E32;&#x884C;&#x7EBF;&#x7684; WIC-2T &#x5361;&quot;](.gitbook/assets/46.png)

_图 1.36 -- 使用小巧串行线的 WIC-2T 卡_
...
![&quot;PuTTY &#x4F7F;&#x7528; COM &#x7AEF;&#x53E3;&#x5F97;&#x5230;&#x4E32;&#x884C;&#x8BBF;&#x95EE;&quot;](.gitbook/assets/47.png)

_图 1.37 -- PuTTY 使用 COM 端口得到串行访问_
...
![&quot;&#x9A71;&#x52A8;&#x7A0B;&#x5E8F;&#x5C06; COM4 &#x4F5C;&#x4E3A;&#x63A7;&#x5236;&#x53F0;&#x8FDE;&#x63A5;&#x7684;&#x7AEF;&#x53E3;&quot;](.gitbook/assets/48.png)

_图 1.38 -- 驱动程序将 COM4 作为控制台连接的端口_
...
![&quot;&#x8D85;&#x7EA7;&#x7EC8;&#x7AEF;&#x8FDE;&#x63A5;&#x53C2;&#x6570;&#x8BBE;&#x7F6E;&quot;](.gitbook/assets/49.png)
