...
![EIGRP&#x6570;&#x636E;&#x5305;&#x5934;&#x90E8;&#x7684;&#x5404;&#x79CD;&#x5B57;&#x6BB5;](.gitbook/assets/3601.png) _图 36.1 -- EIGRP数据包头部的各种字段_
...
![EIGRP&#x6570;&#x636E;&#x5305;&#x5934;&#x90E8;&#x7684;&#x6293;&#x5305;](.gitbook/assets/3602.png) _图 36.2 -- 对EIGRP数据包头部的抓包_
...
![EIGRP&#x7684;&#x66F4;&#x65B0;&#x6570;&#x636E;&#x5305;](.gitbook/assets/3603.png) _图 36.3 -- EIGRP的更新数据包_
...
![EIGRP&#x7684;&#x90BB;&#x5C45;&#x53D1;&#x73B0;&#x4E0E;&#x8DEF;&#x7531;&#x4EA4;&#x6362;](.gitbook/assets/3604.png) _图 36.4 -- EIGRP的邻居发现与路由交换，EIGRP Neighbour Discovery and Route Exchange_
...
![&#x914D;&#x7F6E;&#x9759;&#x6001;&#x7684;EIGRP&#x90BB;&#x5C45;](.gitbook/assets/3605.png) _图 36.5 -- 配置静态的EIGRP邻居_
...
![EIGRP Hello &#x6570;&#x636E;&#x5305;&#x4E2D;&#x7684;EIGRP&#x4FDD;&#x6301;&#x65F6;&#x95F4;](.gitbook/assets/3606.png) _图 36.6 -- EIGRP Hello 数据包中的EIGRP保持时间_
...
![EIGRP&#x7684;&#x53EF;&#x9760;&#x4F20;&#x8F93;&#x534F;&#x8BAE;&#x7684;&#x8FD0;&#x4F5C;](.gitbook/assets/3607.png) _图 36.7 -- EIGRP可靠传输协议的运作_
...
![EIGRP&#x5EA6;&#x91CF;&#x503C;&#x7684;&#x5E26;&#x5BBD;&#x4FEE;&#x6539;](.gitbook/assets/3608.png) _图 36.8 -- EIGRP度量值的带宽修改_
...
![EIGRP&#x5EA6;&#x91CF;&#x503C;&#x4E2D;&#x5EF6;&#x8FDF;&#x7684;&#x4FEE;&#x6539;](.gitbook/assets/3609.png) _图 36.9 -- EIGRP度量值中延迟的修改_
...
![&#x638C;&#x63E1;&#x5F25;&#x6563;&#x66F4;&#x65B0;&#x7B97;&#x6CD5;](.gitbook/assets/3610.png) _图 36.10 -- 掌握弥散更新算法_

参考图36.10, 下表36.4给出了在路由器`R1`上观察到的到`192.168.100.0/24`网络的可行距离及报告距离数值：

_表 36.4 -- `R1`的那些路径及距离, `R1` Paths and Distances_
...
![&#x638C;&#x63E1;EIGRP&#x7684;&#x975E;&#x7B49;&#x4EF7;&#x8D1F;&#x8F7D;&#x5747;&#x8861;](.gitbook/assets/3611.png) _图 36.11 -- 掌握EIGRP的非等价负载均衡，Understanding EIGRP Variance_
...
![EIGRP&#x7684;&#x9ED8;&#x8BA4;&#x8DEF;&#x7531;](.gitbook/assets/3612.png) _图 36.12 -- EIGRP的默认路由_
...
![EIGRP&#x7684;&#x9ED8;&#x8BA4;&#x8DEF;&#x7531;&#xFF08;&#x7EED;&#xFF09;](.gitbook/assets/3613.png) _图 36.13 -- EIGRP的默认路由（续）_
...
![EIGRP&#x7684;&#x6C34;&#x5E73;&#x5206;&#x5272;](.gitbook/assets/3614.png) _图 36.14 -- EIGRP的水平分割_
...
![EIGRP&#x7684;&#x81EA;&#x52A8;&#x8DEF;&#x7531;&#x6C47;&#x603B;](.gitbook/assets/3615.png) _图 36.15 -- EIGRP的自动路由汇总_
...
![&#x4E0D;&#x8FDE;&#x7EED;&#x7F51;&#x7EDC;](.gitbook/assets/3616.png) _图 36.16 -- 不连续网络, Discontiguous Network_
...
![&#x5BF9;&#x5916;&#x90E8;&#x7F51;&#x7EDC;&#x7684;&#x6C47;&#x603B;](.gitbook/assets/3617.png) _图 36.17 -- 对外部网络的汇总，Summrising External Networks_
...
![&#x4E0D;&#x826F;&#x8DEF;&#x7531;&#x6C47;&#x603B;&#x4E0B;&#x7684;&#x6D41;&#x91CF;&#x9ED1;&#x6D1E;&#x95EE;&#x9898;](.gitbook/assets/3618.png) _图 36.18 -- 不良路由汇总下的流量黑洞问题，Black-Holing traffic with Poor Route Summarisation_
...
![&#x8DEF;&#x7531;&#x6C47;&#x603B;&#x4E2D;&#x7684;&#x6B21;&#x4F18;&#x8DEF;&#x7531;&#x95EE;&#x9898;](.gitbook/assets/3619.png) _图 36.19 -- 路由汇总带来的次优路由问题，Suboptimal Routing with Route Summarisation_
...
![&#x8DEF;&#x7531;&#x6C47;&#x603B;&#x4E0B;&#x7684;&#x6B21;&#x4F18;&#x8DEF;&#x7531;](.gitbook/assets/3620.png) _图 36.20 -- 路由汇总下的次优路由，Suboptimal Routing with Route Summarisation_
...
![EIGRP&#x624B;&#x52A8;&#x8DEF;&#x7531;&#x6C47;&#x603B;&#x7684;&#x914D;&#x7F6E;](.gitbook/assets/3621.png) _图 36.21 -- EIGRP手动路由汇总的配置，Configuring EIGRP Manual Route Summarisation_
...
![EIGRP&#x5B9E;&#x9A8C;&#x62D3;&#x6251;&#x56FE;](.gitbook/assets/0909%20%284%29.png)
...
1. 查明两台路由器都对各个网络进行着自动汇总。并于随后在路由器B上关闭自动汇总。
