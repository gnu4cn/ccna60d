...
DTP 是一个_**思科专有的**_点对点协议（point-to-protocol）, 它在两台交换机间协商建立起某种常见中继模式。DTP 会在稍后专门讲到。下面的输出演示了如何将某交换机端口配置为在建立起一条中继链路是采用 IEEE `802.1Q` 封装方式。
...
![&quot;DTP &#x6A21;&#x5F0F;&#x7EC4;&#x5408;&quot;](.gitbook/assets/0301.png)

_图 3.1 -- DTP 模式组合_

图 3.2 示出了将会在两台相邻交换机间成功建立中继链路的有效组合 -- 一端是 DTP 另一端静态配置为中继端口。

![&quot;DTP &#x6A21;&#x5F0F;&#x7EC4;&#x5408;&#xFF0C;&#x7B2C;&#x4E8C;&#x90E8;&#x5206;&quot;](.gitbook/assets/0302.png)

_图 3.2 -- DTP 模式组合，第二部分_
...
![&quot;&#x91C7;&#x7528;&#x591A;&#x4E2A;&#x7269;&#x7406;&#x8DEF;&#x7531;&#x5668;&#x63A5;&#x53E3;&#x7684; VLAN &#x95F4;&#x8DEF;&#x7531;&quot;](.gitbook/assets/0303.png)

_图 3.3 -- 采用多个物理路由器接口的 VLAN 间路由_
...
![&quot;&#x91C7;&#x7528;&#x8DEF;&#x7531;&#x5668;&#x5B50;&#x63A5;&#x53E3;&#x7684; VLAN &#x95F4;&#x8DEF;&#x7531;&quot;](.gitbook/assets/0304.png)

_图 3.4 -- 采用路由器子接口的 VLAN 间路由_
...
![&quot;VTP &#x66F4;&#x65B0;&quot;](.gitbook/assets/0305.png)
...
![&quot;&#x8FD0;&#x884C;&#x4E2D;&#x7684; VTP &#x4FEE;&#x526A;&quot;](.gitbook/assets/0306.png)
...
1. VLAN 间路由无效，Inter-VLAN routing not working:  检查交换机之间的链路、路由器都是正确设置的，以及相关的 VLANs 允许通过且未被修剪（参照 “VTP 修剪” 部分）。`show interface trunk` 命令将提供所需信息。还要检查路由器子接口有配置了正确的封方式和 VLAN，同时子接口的 IP 地址是那些主机的默认网关。
