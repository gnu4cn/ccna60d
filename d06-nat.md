...
![&#x5185;&#x90E8;&#x51ED;&#x636E;&#x88AB;&#x66FF;&#x6362;&#x6210;&#x4E86;&#x5916;&#x90E8;&#x51ED;&#x636E;](.gitbook/assets/0601.png)

_图6.1 -- 内部凭据被替换成了外部凭据_
...
![&#x5185;&#x90E8;&#x5730;&#x5740;&#x88AB;&#x66FF;&#x6362;&#x6210;&#x5916;&#x90E8;&#x5730;&#x5740;](.gitbook/assets/0602.png)
...
![&#x7406;&#x89E3;NAT&#x7684;&#x5404;&#x79CD;&#x5185;&#x90E8;&#x5916;&#x90E8;&#x5730;&#x5740;](.gitbook/assets/0603.png)

_图6.3 -- 理解NAT的各种内部外部地址_
...
![&#x5728;&#x7528;&#x7684;&#x9759;&#x6001;NAT](.gitbook/assets/0604.png)
...
![&#x5230;&#x4E00;&#x4E2A;NAT&#x516C;&#x7F51;&#x53EF;&#x8DEF;&#x7531;&#x5730;&#x5740;&#x6C60;&#x7684;&#x5185;&#x90E8;&#x79C1;&#x6709;&#x5730;&#x5740;](.gitbook/assets/0605.png)

_图6.5 -- 到一个NAT公网可路由地址池的内部私有地址_
...
![NAT Overload](.gitbook/assets/0606.png)
...
![&#x9759;&#x6001;NAT&#x5B9E;&#x9A8C;&#x62D3;&#x6251;&#x56FE;](.gitbook/assets/0607.png)
...
1. 打开NAT调试，如此就可以看到转换的进行。此时再执行另一个扩展`ping`操作（自`L0`接口的），并查看NAT表。因为IOS的不同，你的输出可能与我的不一样。
...
1. 记住，路由器随后很快就会清除该NAT转换，为其它IP地址使用这个/这些NAT地址而对其进行清理。
...
![NAT&#x5730;&#x5740;&#x6C60;/&#x52A8;&#x6001;NAT&#x5B9E;&#x9A8C;&#x62D3;&#x6251;&#x56FE;](.gitbook/assets/0608.png)
...
1. 在`RouterA`上配置一个NAT地址池。在本实验中，使用地址池`172.16.1.1`到`172.16.1.10`。任何以`10`开头的地址，都将成为一个NAT。记住你**必须**指定NAT的内部和外部接口，否则NAT就不会工作。
...
1. 打开NAT调试，如此才可以看到转换的发生。接着执行扩展`ping`（自`L0`和`L1`发出的），并查看NAT表。因为IOS平台的不同，你的输出可能和下面的不一样。将会看到NAT地址池中的两个地址正在用到。
