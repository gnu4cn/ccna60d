...
> 本书译者用其业余时间完成本书的翻译工作，并将其公布到网上，以方便你对网络技术的学习掌握，为使译者更有动力改进翻译及完成剩下章节，你可以捐赠译者:  <img src="images/alipay-banner.png" onmouseover="this.src='images/633086908.png'" onmouseout="this.src='images/alipay-banner.png'" height="15" />&nbsp;&nbsp;<img src="images/wechat-pay-banner.png" onmouseover="this.src='images/611739062.png'" onmouseout="this.src='images/wechat-pay-banner.png'" height="15" />&nbsp;&nbsp;<img src="images/logotop.png" onmouseover="this.src='images/btc-qrcode.png'" onmouseout="this.src='images/wechat-pay-banner.png'" height="15" />
