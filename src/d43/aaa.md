...
所谓 RADIUS 服务器，是指安装了 RADIUS 守护进程或应用的某一设备。与接下来小节将详细介绍的 TACACS+ 不同，RADIUS 属于一项以 C 源代码格式分发的开放标准协议。这实现了来自不同厂商的基于 RADIUS 的产品之间的互操作性与灵活性；然而，正如这一章稍后将解释的，这一点同样是使用 RADIUS 下的主要问题之一。
