...
> **译注**：执行这条命令后，路由器会打印如下日志消息：
>
> ```console
> *Mar  1 03:11:03.659: %FIB-4-UNEQUAL: Range of unequal path weightings too large for prefix 192.168.122.0/24. Some available paths may not be used.
> ```
