...
默认情况下，在初始化后，所有交换机最初都会认为自己是生成树的根，直到它们与其他交换机交换 BPDU。交换机交换 BPDU 时，将进行选举，网络中网桥 ID 最低的交换机将被选为 STP 根桥。如果两台或多台交换机具有相同的优先级，则选择 MAC 地址顺序最低的交换机。下图 10.4 举例说明了这一概念。
