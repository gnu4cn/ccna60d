...
- 无法进行任何类型的 IP 通信，无论是内部还是远端。这通常指向某个可能是某些设备功能失效的重大问题；
...
当咱们第一次安装网络设备时，通常咱们将手动输入 IP 地址信息、以及子网掩码于默认网关。这里的建议是在提交这些信息前加以检查，因为在这方面人为错误非常多。大多数企业网络都有引入新设备到网络的程序手册，包括测试网关和 SNMP 服务器的可达性。
