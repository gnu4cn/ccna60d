...
!["一台模块化路由器，右边有一个空着的插槽"](60days-3.png)
...
!["路由器，routers"](60days-13.png)

!["路由器，routers"](60days-4.png)
路由器，routers

!["交换机，switch"](60days-5.png)
交换机，switch

!["有防火墙的路由器"](60days-6.png)
有防火墙的路由器
...
!["云--电讯端设备"](60days-9.png)
云--电讯端设备

!["终端设备 -- 一台 PC/串行线/以太网连接"](60days-10.png)
...
!["一台主机为找到另一主机 MAC 地址而发出的广播"](60days-28.png)
...
!["路由器采用代理 ARP 技术以允许主机能够连接"](29.png)
...
!["双工拓扑，Duplex Topology"](60days-32.png)
...
!["RJ45 公头"](60days-33.png)
图 1.23 -- RJ45 公头

!["RJ45 母头"](60days-34.png)
图 1.24 -- RJ45 母头
...
!["对比网线两端"](60days-35.png)
图 1.25 -- 对比网线两端

!["网线两端是一样的"](60days-36.png)
图 1.26 -- 网线两端是一样的
...
!["针脚 1 到 针脚 3，针脚 2 到针脚 6"](60days-37.png)
...
!["一条 COM 到 USB 的转换线"](40.png)
图 1.30 -- 一条 COM 到 USB 的转换线

!["将串行线连接到笔记本电脑的串行端口"](41.png)
图 1.31 -- 将串行线连接到笔记本电脑的串行端口

!["将串行线连接到路由器或交换机的控制台端口"](42.png)
...
!["一块 WIC-1T 插卡上的 DB60 串行接口"](44.png)
